...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("best-token"),
	impl_name: create_runtime_str!("best-token"),
	authoring_version: 3,
	spec_version: 4,
	impl_version: 4,
...
impl banners::Trait for Runtime {
	type Event = Event;
}
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		Banners: banners::{Module, Call, Storage, Event<T>},
	}
);
